...
and allows the user to select a new logfile and configuration file. %how? i thought the only way to interact with what was via webpage?
...
and server which handled the request and an object-array of additional information, which depends on the actual database entry.%not logfile entry?
