...
TODO wie zB nicht viele einträge in barchart
...
\subsection{Testing}
The charts were tested via web page, of course with and without filters, for all available
combinations of axis and measure selection. We also let some project extern person test the
charts.
