...
If dimensions of different  configurations have the same name - expect time and location -
...
for fact table and dimension tables were computed completely. Avoiding
