...
{
  name=log file,
  description={Think about beind a child, doing something, then telling your mum. 
Logging is telling your mum about something you did, after you did it.
%also, http://en.wikipedia.org/wiki/Journal_(computing)
%is a file where a large amount of data is saved in one or another form.}
}
