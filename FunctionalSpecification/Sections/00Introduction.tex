...
%Should start with something more soft than: This is
%Maybe start with the Informatik Bachelor at the Kit and that one
%modul is the PSE. Blabla our assignement is blabla.
%deutsch: Und für genau dieses Projekt ist dies hier die func. spec.
...
which is a database for astronomical data. % Our task given in this project consists of
%analyzing and visualizing the sever log of the Skyserver. This is one of the biggist public
% astronomical data bases.
This assignment is one of only two which will be handled %best word
in English.
...
% Last sentence seems needles and repeating
\newline\newline
%according to following secitn: SLP and WHAT got obsolete
% also consider rewriting all the whole splitted part xD
...
logfile which will be parsed into our warehouse. %  split into two senteces
...
implementing the actual program. % standard according to Tichy, sounds like swelling it up
