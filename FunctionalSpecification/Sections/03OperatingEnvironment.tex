...
\begin{itemize}
  \item recent version of th Java Runtime Environment / Java VM  % Glossary
  \item Oracle/MySQL?
\end{itemize}
% I'm not sure about the last point, also we could split it on two servers?
...
\end{itemize}
% Is the funcationality of a web browser connected to the OS?
% If so we have to add this point here!
